...
const UpdateProfile = () => {
  ...
  return (
    ...
    <Form>
      ...
      <UpdateRight>
        <Upload>
          <Image className="userUpdateImg" src={user?.profilePic} alt="" />
          <label htmlFor="file">
            <Publish className="userUpdateIcon" />
          </label>
          <input type="file" id="file" onChange={(e: ChangeEvent<HTMLInputElement>) => setFile(e.target.files && e.target.files[0])} style={{ display: "none" }} />
        </Upload>
